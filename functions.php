...
function bbginnovate_scripts() {
    ...
    if (is_page_template('page-customBBGHomeFlex.php') || is_page_template('page-cards.php')) {
        wp_enqueue_script( 'fittext', get_template_directory_uri() . '/js/jquery.fittext.js', array('jquery'), '20200823', true );
	}
